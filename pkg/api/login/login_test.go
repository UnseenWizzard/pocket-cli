...
func Test_createRequestToken(t *testing.T) {
	tests := []struct {
		name           string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, gotErr := createRequestToken(ts.URL, "app-id", "a redirect uri")
			if (gotErr != nil) != tt.wantErr {
				t.Errorf("createRequestToken() Error = %v, wanted err? %v", gotErr, tt.wantErr)
			}
			if got != tt.want {
				t.Errorf("createRequestToken() = %v, want %v", got, tt.want)
			}
...
func Test_createAccessToken(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, gotErr := createAccessToken(ts.URL, "app-id", "a-request-code")
			if (gotErr != nil) != tt.wantErr {
